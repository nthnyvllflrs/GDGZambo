...
from .views import (
    list_blog, list_draft_blog, list_published_blog, list_waiting_blog,
    view_blog, create_blog, update_blog, delete_blog, publish_blog,
    add_view_photos, delete_photo,
    list_comment, create_comment, delete_comment,
)
